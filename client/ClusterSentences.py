...
#first set api key
set_api_key("11Dkj2PgLbmshgXoqRUgpCUIs7qNp1ROzBjjsnF4hPM1TNkcfy")

## Examples:
## Cluster from a list of sentences
listOfSentences = ["the sky is so high", "the sky is blue", "fly high into the sky.", "the trees are really tall", "I love the trees", "trees make me happy","the sun is shining really bright"]
